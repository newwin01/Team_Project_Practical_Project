...
<div class="animated bounceInDown">
    <div class="container">
        ...
        <form name="form1" class="box" method="post" action="fileUpload" enctype="multipart/form-data">

            <input type="text" name="title" placeholder="제목 입력" id="title" autocomplete="off">

            <input type="text" name="category" placeholder="분류 입력" id="category" autocomplete="off">

            <input type="text" name="writer" placeholder="작가 입력" id="writer" autocomplete="off">


            <input type="number" name="price" placeholder="가격 입력(정수)" id="price" autocomplete="off">
